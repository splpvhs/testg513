    ...
    let customAllSeriesQuestions = [[{"term1":17,"term2":3,"answer":14},{"term1":38,"term2":3,"answer":35},{"term1":12,"term2":3,"answer":9},{"term1":56,"term2":3,"answer":53},{"term1":46,"term2":3,"answer":43}],[{"term1":17,"term2":3,"answer":14},{"term1":46,"term2":3,"answer":43},{"term1":56,"term2":3,"answer":53},{"term1":24,"term2":3,"answer":21},{"term1":38,"term2":3,"answer":35}],[{"term1":56,"term2":3,"answer":53},{"term1":38,"term2":3,"answer":35},{"term1":41,"term2":3,"answer":38},{"term1":69,"term2":3,"answer":66},{"term1":46,"term2":3,"answer":43}],[{"term1":56,"term2":3,"answer":53},{"term1":72,"term2":3,"answer":69},{"term1":69,"term2":3,"answer":66},{"term1":46,"term2":3,"answer":43},{"term1":52,"term2":3,"answer":49}],[{"term1":72,"term2":3,"answer":69},{"term1":69,"term2":3,"answer":66},{"term1":48,"term2":3,"answer":45},{"term1":56,"term2":3,"answer":53},{"term1":71,"term2":3,"answer":68}]];
    ...
    function startSeries(idx) {
      musicEnabled = true;
      getAudioCtx();
      if (!bgAudioPlayer && !synthInterval) {
        startMusicLoop();
      ...
      if(currentScreen === 'main') {
        ...
        for (let idx = 0; idx < seriesCount; idx++) {
          ...
          let actionBtn = unlocked 
            ...
            : '<div class="text-[10px] text-rose-400 font-bold flex items-center gap-1 justify-center"><span class="shrink-0">🔒 مغلق: بحاجة لنقاط ' + formatNumber(7) + '+ بالسلسلة السابقة</span></div>';
          let stars = '';
          if(high !== null) {
            if(high === 10) stars = '⭐⭐⭐';
        ...
        el.innerHTML = `
          <div class="text-right">
            ...
            <p class="text-xs text-desc mb-6 leading-relaxed">تتكون الرحلة من ${formatNumber(seriesCount)} سلاسل تدريجية. نجاحك في الحصول على نقاط ${formatNumber(7)} أو أكثر يفتح لك السلسلة التالية تلقائياً!</p>
